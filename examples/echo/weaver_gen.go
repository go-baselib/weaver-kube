...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/go-baselib/weaver-kube/examples/echo/Echoer",
		Iface: reflect.TypeOf((*Echoer)(nil)).Elem(),
		Impl:  reflect.TypeOf(echoer{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return echoer_local_stub{impl: impl.(Echoer), tracer: tracer, echoMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/go-baselib/weaver-kube/examples/echo/Echoer", Method: "Echo", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return echoer_client_stub{stub: stub, echoMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/go-baselib/weaver-kube/examples/echo/Echoer", Method: "Echo", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦2bd5349f:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/go-baselib/weaver-kube/examples/echo/Echoer⟧\n⟦914f1096:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→echo⟧\n",
	})
}
